...
//En los casos en que no sea UsuarioController->login o UsuarioController->register
if( !(($_GET["controller"] == DEFAULT_CONTROLLER) &&
    ($_GET["action"]==DEFAULT_ACTION || $_GET["action"]==REGISTER_ACTION))){
